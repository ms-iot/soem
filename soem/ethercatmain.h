...
#ifdef soem_EXPORTS
    #define SOEM_DECL __declspec(dllexport)
#else
    #define SOEM_DECL __declspec(dllimport)
#endif

#ifdef EC_VER1
/** global struct to hold default master context */
extern SOEM_DECL ecx_contextt  ecx_context;
/** main slave data structure array */
extern SOEM_DECL ec_slavet   ec_slave[EC_MAXSLAVE];
/** number of slaves found by configuration function */
extern SOEM_DECL int         ec_slavecount;
/** slave group structure */
extern SOEM_DECL ec_groupt   ec_group[EC_MAXGROUP];
extern SOEM_DECL boolean     EcatError;
extern SOEM_DECL int64       ec_DCtime;
